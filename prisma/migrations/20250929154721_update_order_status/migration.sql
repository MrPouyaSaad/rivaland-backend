...
-- AlterEnum
BEGIN;
CREATE TYPE "public"."OrderStatus_new" AS ENUM ('paid', 'processing', 'shipped', 'delivered', 'cancelled', 'returned');
...
ALTER TABLE "public"."Order" ALTER COLUMN "status" SET DEFAULT 'paid';
COMMIT;
